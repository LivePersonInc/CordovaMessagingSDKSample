...
public class LivePerson {
    ...
    public static String getSDKVersion() {
        return "2.0.0";//BuildConfig.VERSION_NAME;
    }
    ...
    public static void handlePush(Context context, Bundle data, String brandId, boolean showNotification) {
        ...
        int notificationIcon = context.getResources().getIdentifier("icon", "drawable", packageName);
        NotificationController.instance.addMessageAndDisplayNotification(context, brandId, message, showNotification, notificationIcon);
    }

...
clearDeviceHistoryAndLogout: function() {
    ...
    lpMessagingSDK.lp_conversation_api(
                                       ...
                                       console.log("@@@ js ... unique clearDeviceHistoryAndLogout SDK callback");
                                       },
                                       function(data) {
                                       var eventData = JSON.parse(data);
                                       console.log("@@@ js ... unique clearDeviceHistoryAndLogout SDK error callback");
                                       }
                                       );
...
lpMessagingSdkInit: function() {
    ...
    console.log('@@@ post lp_register_event_callback...');
    console.log(
                '@@@ pre hello world call in js'
                );
    lpMessagingSDK.hello_world(
                               "hello_world", [this.settings.accountId],
                               function(data) {
                               var eventData = JSON.parse(data);
                               console.log("@@@ js ... unique hello_world  callback");
                               },
                               function(data) {
                               var eventData = JSON.parse(data);
                               console.log("@@@ js ... unique hello_world  error callback");
                               }
                               );
    console.log("@@@ post hello.world call");
